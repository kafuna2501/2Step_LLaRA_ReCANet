...
if __name__ == '__main__':
    ...
    parser.add_argument('--llm_path', default='Qwen/Qwen3-30B-A3B-Instruct-2507-FP8', type=str)
    parser.add_argument('--tokenizer_path', default=None, type=str)
    parser.add_argument('--llm_gguf_file', default=None, type=str)
    parser.add_argument('--llm_dtype', default='auto', choices=['auto', 'bf16', 'fp16', 'fp32'], type=str)
